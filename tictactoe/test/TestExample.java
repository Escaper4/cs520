...
public class TestExample {
	...
	public void testLegalMoveHelper(BlockIndex blockIndex) {
		...
		assertEquals(false,
				game.gameModel.blocksData[blockIndex.getRow()][blockIndex.getColumn()].getIsLegalMove());
	}
	...
	public void testGameOverWin() {
		...
		assertEquals("X",
				game.gameModel.blocksData[player1WinsBlockIndex.getRow()][player1WinsBlockIndex.getColumn()]
						.getContents());
	...
	////////////////////////////////////////////////////////////////////////
	//////// 1. Against a computer player://////////////////////////////////
	//////// After performing a legal move, the game is updated////////////
	//////// appropriately./////////////////////////////////////////////////
	////////////////////////////////////////////////////////////////////////
	...
	public void testComputerUpdate() {
		...
		///// travesal/////////////
		for (int row = 0; row < 3 && !IsUpdate; row++) {
			for (int col = 0; col < 3 && !IsUpdate; col++) {
