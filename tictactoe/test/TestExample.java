...
public class TestExample {
	...
	@Before
	public void setUp() {
		humanGame = new RowGameController();
	...
	// Against a computer player: After performing a legal move, the game is updated
	// appropriately.
	...
	public void testLegalMoveHelper(BlockIndex blockIndex) {
		...
		assertEquals(false,
				humanGame.gameModel.blocksData[blockIndex.getRow()][blockIndex.getColumn()].getIsLegalMove());
	}
	...
	public void testGameOverWin() {
		...
		assertEquals("X",
				humanGame.gameModel.blocksData[player1WinsBlockIndex.getRow()][player1WinsBlockIndex.getColumn()]
						.getContents());
