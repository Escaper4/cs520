...
public class RowGameController {
    ...
    public void move(BlockIndex blockIndex) {
        ...
        if ((blockIndex != null) &&
            ...
            throw new UnsupportedOperationException("Moving to row " + blockIndex.getRow() + " and column "
                    + blockIndex.getColumn() + " is an illegal move.");
        }
    ...
    ///// move for computer///////
    //////////////////////////////
    protected void move4Computer(BlockIndex blockIndex) {
        // Perform input validation
        if ((blockIndex != null)
                && (gameModel.blocksData[blockIndex.getRow()][blockIndex.getColumn()].getIsLegalMove() == false)) {
            throw new UnsupportedOperationException("Moving to row " + blockIndex.getRow() + " and column "
